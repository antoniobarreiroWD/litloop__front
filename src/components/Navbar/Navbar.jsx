...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${
        darkMode
          ? "bg-gradient-to-r from-[#101231] via-secondary to-[#101231]"
      ...
      <div className="container mx-auto flex justify-between items-center p-4 2xl:mb-40 relative max-w-full">
        ...
        <div className="md:hidden flex items-center space-x-4 ml-auto z-50 mt-2 relative">
          ...
          <button
            ...
            className="p-2 rounded-full flex items-center text-black bg-white hover:bg-gray-300"
          >
          ...
          {NAVIGATION_LINK.map(({ link, text }) => {
            ...
            return (
              <NavigationLink
                ...
                } ${darkMode ? "text-white" : "text-gray-900"} hover:underline `}
              >
                {text}
              </NavigationLink>
            );
        ...
        {isMenuOpen && (
          <div className="md:hidden flex flex-col items-center mt-4 space-y-2 z-40">
            ...
            <div className={`flex flex-col items-center gap-2 ${darkMode ? "text-white" : "text-gray-900"}`}>
              {user ? (
                <>
                  <AuthLink to="/profile">
